...
--
-- Applied by scripts/setup.sh with `gcloud spanner databases ddl update`.
-- Statements are separated by semicolons; gcloud splits on them.
--
...
--
-- No ${PLACEHOLDERS} here: the database name is a gcloud argument, not part
